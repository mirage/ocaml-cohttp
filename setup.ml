...
(* OASIS_START *)
(* DO NOT EDIT (digest: ec48a0d36629b951cdba5b9794bf93e0) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "mirage-http-unix";
     ...
     oasis_version = "0.4.0";
     oasis_digest = Some "Á\029Hu\133£`Ê\1289ûã\012\tc\014";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
