...
(* OASIS_START *)
(* DO NOT EDIT (digest: cb053bbd70b68e2552d8a0b9d53b673c) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          sections =
            [
               ...
               Executable
                 ({
                     cs_name = "server_lwt_custom_stream_doc_example";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = true;
                      exec_main_is = "server_lwt_custom_stream.ml"
                   });
               Executable
                 ({
                     cs_name = "test_sanity";
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "4\020\019\007`]\016\135\131\215\213`\001\187j\140";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
