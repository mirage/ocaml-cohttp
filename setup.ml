...
(* OASIS_START *)
(* DO NOT EDIT (digest: b0a4c9bc9f1391cc8cea546e7cf59306) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = true; exec_main_is = "test_net.ml"; });
               Test
                 ({
                     cs_name = "test_base64";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\146\130vs\146³MK\135\1414¥À1Y±";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
