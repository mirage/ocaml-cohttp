...
(* OASIS_START *)
(* DO NOT EDIT (digest: 5a5524392141080fcdd7a30042a0e551) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = true; exec_main_is = "cohttp_client_lwt.ml"
                   });
               Executable
                 ({
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\023\"\190-\245\213\029z'\167\215!2\017\128=";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
