...
(* OASIS_START *)
(* DO NOT EDIT (digest: 9e250250ed25c7e7b00d323de2025f55) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_base64", []))];
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Cohttp_lwt_client"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "cohttp";
                      lib_findlib_name = Some "lwt_client";
                      lib_findlib_containers = [];
                      });
               Library
                 ({
                     cs_name = "cohttp_lwt_server";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {
                      lib_modules = ["Cohttp_lwt_server"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "cohttp";
                      lib_findlib_name = Some "lwt_server";
                      lib_findlib_containers = [];
                      });
               Doc
                 ({
               ...
               Executable
                 ({
                   ...
                   {exec_custom = true; exec_main_is = "test_base64.ml"; });
               Test
                 ({
                     cs_name = "test_base64";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "IG¾É\136¬\150KÆ\142´\154\0142>\148";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
