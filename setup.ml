...
(* OASIS_START *)
(* DO NOT EDIT (digest: d37aa37c3d345297a049a6a723a9e38c) *)
(*
...
(* # 21 "/auto/homes/jdy22/.opam/4.00.1/build/oasis.0.3.0/src/plugins/custom/CustomPlugin.ml" *)
...
let setup_t =
  {
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\254q\188\149\133\170\226\216\129&\t-9A\139\147";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
