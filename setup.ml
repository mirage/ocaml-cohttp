...
(* OASIS_START *)
(* DO NOT EDIT (digest: 6352a578cd8fd2b9c517c56a37f79cb2) *)
(*
...
let setup_t =
  {
               ...
               post_command =
                 [
                    (OASISExpr.EBool true,
                      Some
                        (("./scripts/detect_async_ssl.sh",
                           ["$async_ssl"; ">"; "async/cohttp_async_incl.ml"])))
                 ]
            };
            ...
            [
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "build with Async SSL support";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Flag
                 ({
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "\024\021\029ΩÀ…\004∆WΩi∑/\005‡E";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
